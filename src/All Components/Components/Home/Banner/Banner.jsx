            ...
            >
                <SwiperSlide>
                    <div>
                        ...
                        {/* fuel section */}
                        <div className="absolute -mt-[350px] md:-mt-[440px] md:ml-36">
                            <h1 id="color2" className="text-5xl md:text-7xl font-bold text-white">Fuel your <br />ambition</h1>

                            <div className="flex gap-2 mt-10">
                                <input type="text" placeholder="Search our 4000+ courses" className="relative border-2 border-black  px-2 py-1 w-48 md:w-64 max-w-xs" />
                        ...
                        <div className="absolute -mt-10 relative w-9/12 bg-green-800 py-4 ">
                            <p className="text-white text-base md:text-3xl text-right pr-10">Recognized for AI innovations in learning</p>


                        </div>
                        <img className=" absolute -mt-28 h-28 md:h-36 w-20 md:w-28 ml-52 md:ml-36 hidden md:block" src={logo} alt="" />
                    </div>
                </SwiperSlide>
